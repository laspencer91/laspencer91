...
- **[ctx-engine](https://github.com/laspencer91/ctx-engine)** - Cross-project architectural knowledge system for AI coding agents. MCP server that captures and connects knowledge across codebases.
